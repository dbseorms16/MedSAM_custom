...
class NpyDataset(Dataset): 
    ...
    def __getitem__(self, index):
        ...
        gt2D = cv2.resize(gt2D.astype('float32'), (256,256))
...
parser.add_argument('-i', '--tr_npy_path', type=str, default='data/Pre_embedding/train', help='path to training npy files; two subfolders: npy_gts and npy_embs')
